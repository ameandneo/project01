...
<body>
  <nav class="d-flex align-items-start sidebar">
    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <li>
        <a class="d-flex flex-column navbar-brand fs-3 mb-4" href="#"><img src="" alt="" class="me-2" />後台管理系統</a>
      </li>

      <a class="nav-link <?= $pageName == 'create' ? 'active' : '' ?>" href="./create.php"><div class="link-deco rounded-circle"></div><i class="fa-solid fa-file-circle-plus"></i>
        新增課程
      </a>
      <a class="nav-link" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fa-solid fa-file-circle-plus"></i>
        我創建的課程
      </a>
      ...
      <a class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">
