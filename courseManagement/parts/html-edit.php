<?php
require __DIR__ . '/parts/PDOconnect.php';
$sid = isset($_GET['sid']) ? intval($_GET['sid']) : 0;

// if (empty($sid)) {//如果不是點編輯紐進來的就跳回list頁
//     header('Location:');
// }
...
<div class="container-right">
    ...
    <form name="editCourse" onsubmit="sendData(event)" method="post">
        <div class="mb-3">
            ...
            <!-- 新增一個隱藏的input，表單提交會送出sid -->
            <label for="courseID" class="form-label">課程編號</label>
            <input type="text" class="form-control disabled readonly" id="courseID" name="courseID">
